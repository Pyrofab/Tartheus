...
public class FramebufferReplacement extends Framebuffer {
    ...
    public static void replaceMinecraftFramebuffer() {
        ...
        setPrivateValue(Minecraft.class, mc, "field_147124_at", Framebuffer.class, replacement);
    }
    ...
    public static int getMainDepthTexture() {
        ...
        if (mainDepthTexture < -1) {
            ...
            if (attachmentObjectType != GL_TEXTURE) {
                ...
                Tartheus.LOGGER.warn("Minecraft main framebuffer has not been replaced by our version (expected a texture attachment, got {} in {})", type, Minecraft.getMinecraft().getFramebuffer().getClass().getName());
                mainDepthTexture = -1;
            } else {
