...
public class ParticleBloodGushEnder extends Particle
{
    
    public ParticleBloodGushEnder(final World world, final double x, final double y, final double z, final double power, final int r, final int g, final int b) {
