...
public class BasicBlockPane extends Block implements ModelRegistry 
{
	...
	@Override
	public BasicBlockPane setCreativeTab(CreativeTabs tab) {
    ...
    {
        return blockIn.getDefaultState().isFullCube() || blockIn == this || blockIn == Blocks.GLASS || blockIn == Blocks.STAINED_GLASS || blockIn == Blocks.STAINED_GLASS_PANE || blockIn instanceof BasicBlockPane;
    }
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        return connector instanceof BasicBlockPane;
    }
