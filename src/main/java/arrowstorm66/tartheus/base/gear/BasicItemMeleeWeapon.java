...
public class BasicItemMeleeWeapon extends BasicItem implements ModelRegistry, IReach, ICriticalStrike {
	...
	public BasicItemMeleeWeapon(String name, MToolMaterial material, double attackDamage, double attackSpeed, float reach,
		...
		setCreativeTab(MCreativeTabs.T_WEAPONS);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(TextFormatting.GRAY + I18n.format("Reach") + ": " + reach);

		DecimalFormat format = new DecimalFormat("###");
		tooltip.add(TextFormatting.GRAY + I18n.format("Critical Chance") + ": " + format.format(criticalChance * 100)
				+ "%");
	}
