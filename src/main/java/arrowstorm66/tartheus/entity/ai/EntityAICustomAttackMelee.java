...
public class EntityAICustomAttackMelee extends EntityAIBase
{
    World world;
    ...
    public EntityAICustomAttackMelee(EntityCreature creature, double attackRadius, double speedIn, boolean useLongMemory)
    {
