...
public class EntityAILurkerAttack extends EntityAIBase
{
    World world;
    ...
    public EntityAILurkerAttack(EntityCreature creature, double attackRadius, double speedIn, boolean useLongMemory)
    {
