...
public class BlockBarrenwoodLeaves extends BlockLeaves implements ModelRegistry {

	protected static String name;

	public BlockBarrenwoodLeaves(Material material, String name, float hardness, String tool, int level) {
		super();
		BlockBarrenwoodLeaves.name = name;
	...
	@Override
	public BlockBarrenwoodLeaves setCreativeTab(CreativeTabs tab) {
		super.setCreativeTab(tab);
		return this;
	}

	@Override
	public BlockBarrenwoodLeaves setSoundType(SoundType tile) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(MBlocks.BARRENWOOD_SAPLING);
	}
