...
public class BlockAlderSapling extends BlockBush implements IGrowable, ModelRegistry {
	...
	@Override
	public BlockAlderSapling setCreativeTab(CreativeTabs tab) {
		super.setCreativeTab(tab);
		return this;
	}

	@Override
	public BlockAlderSapling setSoundType(SoundType tile) {
	...
	protected boolean canSustainBush(final IBlockState ground) {
		return ground.getBlock() == MBlocks.TARTHEUS_GRASS || ground.getBlock() == MBlocks.TARTHEUS_COARSE_DIRT
				|| ground.getBlock() == MBlocks.TARTHEUS_SAND || ground.getBlock() == MBlocks.HELL_SAND;
	}
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos))
			return;
		WorldGenerator worldgenerator = new WorldGenAlderShrub();
