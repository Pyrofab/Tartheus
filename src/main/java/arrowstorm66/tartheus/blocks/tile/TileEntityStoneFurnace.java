...
public class TileEntityStoneFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockStoneFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = TartheusFurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = TartheusFurnaceRecipes.instance().getSmeltingResult(itemstack);
