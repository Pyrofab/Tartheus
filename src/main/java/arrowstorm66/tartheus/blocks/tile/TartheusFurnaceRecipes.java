...
public class TartheusFurnaceRecipes {
	 ...
	 */
	public static TartheusFurnaceRecipes instance() {
		return SMELTING_BASE;
	}

	private TartheusFurnaceRecipes() {
		// Vanilla
